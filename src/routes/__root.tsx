...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Pioneer Hub Africa — Where learning meets innovation." },
      ...
      { property: "og:title", content: "Pioneer Hub Africa — Where learning meets innovation." },
      ...
      { name: "twitter:title", content: "Pioneer Hub Africa — Where learning meets innovation." },
